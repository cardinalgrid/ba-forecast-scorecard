...
- 72 balancing authorities appear in the files; 58 report both demand and a day-ahead forecast; **42 are eligible for ranking** (at least 180 scored days, mean demand >= 500 MW, and |median daily bias| <= 25%). 210,301 BA-days and 5,040,635 hours were scored.
...
- 114,737 hours were flagged implausible (forecast/demand outside [1/2, 2], or forecast <= 0; excluded from error metrics) and excluded from error metrics; EIA-imputed demand was 0.0002% of scored hours.
